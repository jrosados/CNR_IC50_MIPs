...
WAF_CAF_regions_year_table<- table1(~  region | year
     , data = WAF_CAF_countries_before2019_after2019)

write.csv(WAF_CAF_regions_year_table, "tables/WAF_CAF_regions_year_table.csv", row.names = F)
...
#####################################################
#   WAF AND CAF COUNTRIES STRATIFIED BY TIME PERIOD #
#                                                   #
#####################################################

WAF_CAF_countries_year_table<- table1(~  country | year
     , data = WAF_CAF_countries_before2019_after2019)
...
fisher.test(WAF_CAF_countries_before2019_after2019$country,
           WAF_CAF_countries_before2019_after2019$year, simulate.p.value = TRUE)

WAF_CAF_countries_year_stats<- CreateTableOne(vars = c("country"), strata = "year", data = WAF_CAF_countries_before2019_after2019)
